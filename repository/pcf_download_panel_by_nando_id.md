# [PCF] FILTER: DOWNLOAD PANEL by NANDO ID - https://dev-pubcasefinder.dbcls.jp/sparql
## Parameters
* `nando_id` NANDO ID
  * default: 1200021
...
SELECT DISTINCT
(CONCAT("NANDO:", "{{nando_id_list}}" )) AS ?panel_disease_id
?panel_disease_name
?reference_mondo_id
...
WHERE {
  # mondo_input 라벨
  VALUES ?mondo_input { {{nando_id_list}} }
